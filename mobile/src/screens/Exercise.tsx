...
import { createTagAboutLastExerciseOfUser } from "src/notifications/oneSignal";
...
export function Exercise() {
  ...
  async function handleExerciseHistoryRegister() {
    try {
      ...
      toast.show({
        title: 'This exercises is in your history now !',
        placement : 'bottom',
        bgColor : 'green.700'
      })

      createTagAboutLastExerciseOfUser(String(new Date()))
      ...
      <ScrollView>
        ...
        <Box bg={"gray.600"} rounded={"md"} pb={4} px={4}>
          <HStack alignItems={"center"} justifyContent={"center"} mb={6} mt={5}>
            ...
            <Button onPress={handleExerciseHistoryRegister} disabled={submittingRegister} isLoading={submittingRegister} title="mark as done" />
          </HStack>
        </Box>
      </VStack>}
      </ScrollView>
